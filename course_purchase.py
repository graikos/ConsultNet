...
class CoursePurchase(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        name_label.pack()
        experience_label = ttk.Label(master=left_down_frame, text= self.course.cons.experience, font= 'Montserrat 7 bold')
        experience_label.pack()
        education_label = ttk.Label(master=left_down_frame, text= self.course.cons.education, font= 'Montserrat 7 bold')
        ...
        description_frame.pack(anchor='w')
        description_label1 = ttk.Label(master=description_frame, text='Description:', font='Montserrat 7 bold')
        description_label1.pack(anchor='nw', side='left',padx=(0,20))
        description_paragraph = ttk.Label(master=description_frame, text=self.course.description, font='Montserrat 7', wraplength=600)
        description_paragraph.pack(anchor='w', side='left')
        description_frame.pack()
        sales_frame = ttk.Frame(master=right_down_frame)
        sales_label1 = ttk.Label(sales_frame, text='Purchased by:', font= 'Montserrat 7 bold')
        sales_label1.pack(anchor='w',padx=(0,20),side='left')
        sales_label2 = ttk.Label(sales_frame, text= str(self.course.num_of_sales), font= 'Montserrat 7')
        sales_label2.pack(anchor='w',side='left')
        sales_frame.pack(anchor='w')
        posted_on_frame = ttk.Frame(master=right_down_frame)
        posted_on_label1 = ttk.Label(master=posted_on_frame, text='Posted on:', font= 'Montserrat 7 bold')
        posted_on_label1.pack(anchor='w',side='left',padx=(0,20))
        posted_on_label2 = ttk.Label(master=posted_on_frame, text=self.course.posted_on, font= 'Montserrat 7 ')
        posted_on_label2.pack(anchor='w',side='left')
        posted_on_frame.pack(anchor='w')
        final_exam_frame = ttk.Frame(master=right_down_frame)    
        final_exam_label1 = ttk.Label(master=final_exam_frame, text='Final Exam:', font= 'Montserrat 7 bold')
        final_exam_label1.pack(anchor='w',side='left',padx=(0,20))
        final_exam_label2 = ttk.Label(master=final_exam_frame, text=self.course.final_exam, font= 'Montserrat 7')
        final_exam_label2.pack(anchor='w',side='left')
        final_exam_frame.pack(anchor='w')
        category_frame = ttk.Frame(master=right_down_frame)
        category_label1 =  ttk.Label(master=category_frame, text="Category:", font= 'Montserrat 7 bold')
        category_label1.pack(anchor='w',side='left',padx=(0,20))
        for cat in self.course.categories:
            category_label2 = ttk.Label(master=category_frame, text= cat, font= 'Montserrat 7')
            category_label2.pack(anchor='w',side='left')
        category_frame.pack(anchor='w')
        media_frame = ttk.Frame(master=right_down_frame)    
        media_label1 = ttk.Label(master=media_frame, text='Media:', font= 'Montserrat 7 bold')
        media_label1.pack(anchor='w',side='left',padx=(0,20))
        media_label2 = ttk.Label(master=media_frame, text=str(self.course.media.type), font= 'Montserrat 7')
        media_label2.pack(anchor='w',side='left')
        media_frame.pack(anchor='w')        
        ...
        ch.state(["!alternate"])
        ch.pack(anchor="w", padx=20, pady=5)
