...
class CoursePurchase(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        name_label.pack()
        experience_label = ttk.Label(master=left_down_frame, text="Experience:  "+ self.course.cons.experience, font= 'Montserrat 7 bold')
        experience_label.pack(anchor="w",padx=15,pady=10)
        education_label = ttk.Label(master=left_down_frame,  text="Education:  "+ self.course.cons.education, font= 'Montserrat 7 bold')
        education_label.pack(anchor="w",padx=15,pady=10)
