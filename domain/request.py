...
class Request:
    def __init__(
        self, name, description, user, esth, cons, compensation, categories, posted_on
    ):
        self.name = name
